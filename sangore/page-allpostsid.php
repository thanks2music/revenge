...
?>
<h2>「<a href="<?php echo get_category_link( $category->term_id ); ?>"><?php echo $category->cat_name; ?></a>」のカテゴリーIDは「<?php echo $category->term_id; ?>」</h2>
	<ul>
	<?php
		query_posts('cat='.$category->cat_ID.'&posts_per_page=100');
		if (have_posts()) : while (have_posts()) : the_post();
	?>
	<li>「<a href="<?php the_permalink() ?>"><?php the_title(); ?></a>」の投稿IDは「<span style="color:skyblue"><?php echo get_the_ID(); ?></span>」</li>
	<?php endwhile; endif; ?>
	</ul>
<?php endforeach; ?>
</body>
